...
class AsignacionTareas():
    ...
    def crear_tareas_usuario(usuario):
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Constancia de CBU',descripcion='Imagen de constancia de CBU',descarga='NOTA CBU TERCEROS.doc').save()
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Cuentas Activas Firmadas',descripcion='Descargar, para firmar y subir archivo', descarga = 'CUENTAS UNICAS DE PAGO.pdf').save()
