...
class AsignacionTareas():
    ...
    def crear_tareas_usuario(usuario):
        tarea = Tareas.objects.create(user = usuario, titulo = 'DNI Frente',descripcion='Foto frente dni del que firmo el boleto',).save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'DNI Dorso',descripcion='Foto dorso dni del que firmo el boleto').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Constancia Cuit',descripcion='Constancia de CUIT de la reventa').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Estatuto',descripcion='Estatuto completo en 1 archivo PDF').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Ultima designacion de cargo',descripcion='Si no corresponde, marcar como completo').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Constancia de CBU',descripcion='Imagen de constancia de CBU').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Autorizacion Firmada',descripcion='Se necesita autorizacion en caso que la constancia de CBU no concuerde LINK DESCARGA').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Cuentas Activas Firmadas',descripcion='Descargar, para firmar y subir archivo').save()
    ...
    def crear_tareas_retiro_individuo(usuario,preventa):
        tarea = Tareas.objects.create(user = usuario, titulo = 'DNI Frente',descripcion='Foto frente dni del que retira',pv=preventa).save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'DNI Dorso',descripcion='Foto dorso dni del que retira',pv=preventa).save()
    ...
    def crear_tareas_preventa_financiado(usuario,preventa):
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Anexo 1.2 del credito',descripcion='Descargar, para firmar y subir archivo (Titular de la prenda)',pv=preventa,descarga='Anexo 1.2').save()
    ...
    def crear_tareas_preventa_persona_fisica(usuario,preventa):
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Pedido de refacturacion',descripcion='Descargar el archivo, debe firmar el mismo que firmo el boleto',pv=preventa,descarga='archivo').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Fisica',descripcion='Descargar el archivo, debe firmar y adjuntar',pv=preventa,descarga='ddj fisica').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Expuesta Politicamente',descripcion='Descargar el archivo, debe firmar y adjuntar',pv=preventa,descarga='ddj PEP').save()
    ...
    def crear_tareas_preventa_persona_juridica(usuario,preventa):
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Juridica',descripcion='Descargar el archivo, debe firmar y adjuntar',pv=preventa,descarga='ddj juridica').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Expuesta Politicamente',descripcion='Descargar el archivo, debe firmar y adjuntar',pv=preventa,descarga='ddj PEP').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Certificacion Contable',descripcion='Adjuntar 1 solo archivo',pv=preventa,descarga='ddj PEP').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Guarda Habitual',descripcion='Se debe cargar si desea paatentar en un domicilio diferente',pv=preventa,descarga='ddj PEP').save()
    ...
    def crear_socio_persona_fisica(usuario,preventa):
        ...
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Fisica Socio',descripcion='Descargar el archivo, debe firmar y adjuntar (Socio para persona juridica)',pv=preventa,descarga='ddj fisica').save()
        tarea = Tareas.objects.create(user = usuario, titulo = 'Declaracion Jurada Persona Expuesta Politicamente Socio',descripcion='Descargar el archivo, debe firmar y adjuntar (Socio para persona juridica)',pv=preventa,descarga='ddj PEP').save()
